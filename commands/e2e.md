...
npx playwright test tests/e2e/xxx.spec.ts  # 运行特定测试
npx playwright test --headed               # 有头模式（看到浏览器）
npx playwright test --debug                # 调试测试
npx playwright codegen http://localhost:3000  # 生成测试代码
